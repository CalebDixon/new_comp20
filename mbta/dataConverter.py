...
#written by a very helpful anonymous classmate
#this script is not run by the webpage, but was used
#to generate the data which is hard coded in

# converts stop data to json and sorts by line order
